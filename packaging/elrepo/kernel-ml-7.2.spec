...
Version: %{pkg_version}
Release: %{pkg_release}
ExclusiveArch: x86_64 x86_64_v2 aarch64 noarch
ExclusiveOS: Linux
...
# Adjust the FIPS module name for RHEL10.
for i in config-%{version}-*; do
	sed -i 's@CONFIG_CRYPTO_FIPS_NAME=.*@CONFIG_CRYPTO_FIPS_NAME="Red Hat Enterprise Linux 10 - Kernel Cryptographic API"@' $i
done
...
* Fri Aug 28 2026 Akemi Yagi <toracat@elrepo.org> - 7.2.2-1
- Updated with the 7.2.2 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v7.x/ChangeLog-7.2.2]
...
* Wed Aug 19 2026 Akemi Yagi <toracat@elrepo.org> - 7.1.9-1
- Updated with the 7.1.9 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v7.x/ChangeLog-7.1.9]

* Sun Aug 09 2026 Akemi Yagi <toracat@elrepo.org> - 7.1.8-1
- Updated with the 7.1.8 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v7.x/ChangeLog-7.1.8]

* Thu Aug 06 2026 Akemi Yagi <toracat@elrepo.org> - 7.1.7-1
- Updated with the 7.1.7 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v7.x/ChangeLog-7.1.7]

* Mon Aug 03 2026 Akemi Yagi <toracat@elrepo.org> - 7.1.6-1
- Updated with the 7.1.6 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v7.x/ChangeLog-7.1.6]

* Fri Jul 24 2026 Akemi Yagi <toracat@elrepo.org> - 7.1.5-1
- Updated with the 7.1.5 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v7.x/ChangeLog-7.1.5]

* Sat Jul 18 2026 Akemi Yagi <toracat@elrepo.org> - 7.1.4-1
- Updated with the 7.1.4 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v7.x/ChangeLog-7.1.4]

* Sat Jul 04 2026 Akemi Yagi <toracat@elrepo.org> - 7.1.3-1
- Updated with the 7.1.3 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v7.x/ChangeLog-7.1.3]

* Sat Jun 27 2026 Akemi Yagi <toracat@elrepo.org> - 7.1.2-1
...
* Mon Jun 01 2026 Akemi Yagi <toracat@elrepo.org> - 7.0.11-1
- Updated with the 7.0.11 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v7.x/ChangeLog-7.0.11]

* Sat May 23 2026 Akemi Yagi <toracat@elrepo.org> - 7.0.10-1
- Updated with the 7.0.10 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v7.x/ChangeLog-7.0.10]

* Sun May 17 2026 Akemi Yagi <toracat@elrepo.org> - 7.0.9-1
- Updated with the 7.0.9 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v7.x/ChangeLog-7.0.9]

* Fri May 15 2026 Akemi Yagi <toracat@elrepo.org> - 7.0.8-1
- Updated with the 7.0.8 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v7.x/ChangeLog-7.0.8]

* Thu May 14 2026 Akemi Yagi <toracat@elrepo.org> - 7.0.7-1
- Updated with the 7.0.7 source tarball.
...
- Updated with the 7.0 source tarball.
  [https://www.kernel.org/pub/linux/kernel/v7.x/ChangeLog-7.0]

* Sat Apr 11 2026 Akemi Yagi <toracat@elrepo.org> - 6.19.12-1
- Updated with the 6.19.12 source tarball.
  [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.19.12]

* Thu Apr 02 2026 Akemi Yagi <toracat@elrepo.org> - 6.19.11-1
- Updated with the 6.19.11 source tarball.
  [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.19.11]

* Wed Mar 25 2026 Akemi Yagi <toracat@elrepo.org> - 6.19.10-1
- Updated with the 6.19.10 source tarball.
  [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.19.10]

* Thu Mar 19 2026 Akemi Yagi <toracat@elrepo.org> - 6.19.9-1
- Updated with the 6.19.9 source tarball.
  [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.19.9]

* Fri Mar 13 2026 Akemi Yagi <toracat@elrepo.org> - 6.19.8-1
- Updated with the 6.19.8 source tarball.
  [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.19.8]

* Thu Mar 12 2026 Akemi Yagi <toracat@elrepo.org> - 6.19.7-1
- Updated with the 6.19.7 source tarball.
  [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.19.7]

* Wed Mar 04 2026 Akemi Yagi <toracat@elrepo.org> - 6.19.6-1
- Updated with the 6.19.6 source tarball.
  [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.19.6]

* Fri Feb 27 2026 Akemi Yagi <toracat@elrepo.org> - 6.19.5-1
- Updated with the 6.19.5 source tarball.
  [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.19.5]

* Thu Feb 26 2026 Akemi Yagi <toracat@elrepo.org> - 6.19.4-1
...
* Fri Jan 30 2026 Akemi Yagi <toracat@elrepo.org> - 6.18.8-1
- Updated with the 6.18.8 source tarball.
  [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.18.8]

* Fri Jan 23 2026 Akemi Yagi <toracat@elrepo.org> - 6.18.7-1
- Updated with the 6.18.7 source tarball.
  [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.18.7]

* Sat Jan 17 2026 Akemi Yagi <toracat@elrepo.org> - 6.18.6-1
- Updated with the 6.18.6 source tarball.
  [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.18.6]

* Sun Jan 11 2026 Akemi Yagi <toracat@elrepo.org> - 6.18.5-1
- Updated with the 6.18.5 source tarball.
  [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.18.5]

* Thu Jan 08 2026 Akemi Yagi <toracat@elrepo.org> - 6.18.4-1
- Updated with the 6.18.4 source tarball.
...
* Thu Nov 13 2025 Akemi Yagi <toracat@elrepo.org> - 6.17.8-1
- Updated with the 6.17.8 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.17.8]

* Sun Nov 02 2025 Akemi Yagi <toracat@elrepo.org> - 6.17.7-1
- Updated with the 6.17.7 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.17.7]

* Wed Oct 29 2025 Akemi Yagi <toracat@elrepo.org> - 6.17.6-1
- Updated with the 6.17.6 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.17.6]

* Thu Oct 23 2025 Akemi Yagi <toracat@elrepo.org> - 6.17.5-1
- Updated with the 6.17.5 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.17.5]

* Sun Oct 19 2025 Akemi Yagi <toracat@elrepo.org> - 6.17.4-1
- Updated with the 6.17.4 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.17.4]

* Wed Oct 15 2025 Akemi Yagi <toracat@elrepo.org> - 6.17.3-1
- Updated with the 6.17.3 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.17.3]

* Sun Oct 12 2025 Akemi Yagi <toracat@elrepo.org> - 6.17.2-1
- Updated with the 6.17.2 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.17.2]

* Mon Oct 06 2025 Akemi Yagi <toracat@elrepo.org> - 6.17.1-1
- Updated with the 6.17.1 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.17.1]

* Thu Oct 02 2025 Akemi Yagi <toracat@elrepo.org> - 6.16.10-1
- Updated with the 6.16.10 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.16.10]

* Thu Sep 25 2025 Akemi Yagi <toracat@elrepo.org> - 6.16.9-1
- Updated with the 6.16.9 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.16.9]

* Fri Sep 19 2025 Akemi Yagi <toracat@elrepo.org> - 6.16.8-1
- Updated with the 6.16.8 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.16.8]

* Thu Sep 11 2025 Akemi Yagi <toracat@elrepo.org> - 6.16.7-1
- Updated with the 6.16.7 source tarball.
- [https://www.kernel.org/pub/linux/kernel/v6.x/ChangeLog-6.16.7]
